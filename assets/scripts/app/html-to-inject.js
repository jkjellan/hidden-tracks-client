  ...
  `<div class='my-song-card mdl-cell--middle mdl-card mdl-cell mdl-cell--12-col mdl-shadow--2dp'>` +
    ...
    "<div class='mdl-card__actions'>" +
      `<button id='button1' class='mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon'>` +
        ...
        "<span class='visuallyhidden'>Accounts</span>" +
      "</button>" +
      `<ul class='mdl-menu mdl-menu--top-left mdl-js-menu mdl-js-ripple-effect' for='button1'>` +
        `<li data-id='1' class='edit-song mdl-menu__item'>Edit Song</li>` +
        `<li data-id='1' class='delete-song mdl-menu__item'>Delete Song</li>` +
      "</ul>" +
    "</div>" +
  "</div>"
